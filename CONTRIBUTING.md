# Contributing to ejsrmoa test repo

This document describes how to contribute to the ejsrmoa test repo Project.
...
ejsrmoa test repo artifacts are stored in the Gerrit project: [OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-pocs-ejsrmoa-test](https://gerrit.ericsson.se/#/admin/projects/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-pocs-ejsrmoa-test)
  
### Documents

The documentation for this service is located in the [doc folder](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-pocs-ejsrmoa-test/+/master/doc).

To update documents that are not in the referenced folder, contact the service guardians mentioned in the [README.md](https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-pocs-ejsrmoa-test/+/master/README.md).
...
The code-review scores and corresponding workflow activities are as follows:
   ...
   [README.md] (https://gerrit.ericsson.se/plugins/gitiles/OSS/com.ericsson.oss.ci.test/eric-oss-common-ci-pocs-ejsrmoa-test/+/master/README.md)