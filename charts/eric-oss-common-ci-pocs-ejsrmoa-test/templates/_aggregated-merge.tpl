...
*/ -}}
{{- define "eric-oss-common-ci-pocs-ejsrmoa-test.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-oss-common-ci-pocs-ejsrmoa-test.mergeAnnotations" -}}
  {{- include "eric-oss-common-ci-pocs-ejsrmoa-test.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}
{{- define "eric-oss-common-ci-pocs-ejsrmoa-test.mergeLabels" -}}
  {{- include "eric-oss-common-ci-pocs-ejsrmoa-test.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
